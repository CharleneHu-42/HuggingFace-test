...
model_list=("Qwen/Qwen2.5-1.5B-Instruct" "facebook/opt-1.3b" "gpt2" "meta-llama/Llama-3.1-8B-Instruct")
...
model_list=("meta-llama/Llama-3.2-11B-Vision-Instruct" "llava-hf/llava-v1.6-mistral-7b-hf" "Qwen/Qwen2-VL-7B-Instruct")
...
model_list=("llava-hf/LLaVA-NeXT-Video-7B-hf" "KangarooGroup/kangaroo")

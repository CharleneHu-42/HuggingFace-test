...
def main(
    ...
    save_skipped_stats_to_excel(tests_df, os.path.join(output_dir, "skipped_tests_stats.xlsx"))
    save_failed_stats_to_excel(tests_df, os.path.join(output_dir, "failed_tests_stats.xlsx"))
